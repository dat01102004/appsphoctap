...
class _NewsAssistantScreenState extends State<NewsAssistantScreen> {
  ...
  Future<void> _stopNewsSilently() async {
    try {
      await _news.silentStop(clearItems: false);
    } catch (_) {}
  ...
  Future<void> _goBackByHand() async {
    await _stopNewsSilently();
